              ...
              {isLoading ? (
                ...
                <div className="space-y-4 animate-in fade-in slide-in-from-bottom-2 duration-700">
                  <div className="flex items-center gap-2 mb-2">
                    <Sparkles
                      size={14}
                      className="text-[hsl(var(--hero-glow))]"
                    />
                    <span className="text-[10px] font-black text-white/30 uppercase tracking-[0.2em]">
                      Architect Query Result
                    </span>
                  </div>
        ...
        {!response && !isLoading && (
          <div className="px-6 py-4 border-t border-white/5 bg-white/[0.01] flex items-center gap-6">
            <div className="flex items-center gap-2">
              <span className="px-1.5 py-0.5 rounded bg-white/10 text-[9px] font-mono text-white/60">
                ESC
              </span>
