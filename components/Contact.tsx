    ...
    <section id="contact" className="relative space-y-16 py-12">
      ...
      <div className="flex flex-col gap-4 max-w-3xl">
        ...
        <p className="text-white/40 text-base md:text-lg font-light leading-relaxed">
          ...
          projects, or just talking about technology and system architecture.
        </p>
      </div>
      ...
      <div className="flex flex-col justify-between sm:flex-row items-start gap-4 pt-4">
        ...
        <div className="flex flex-col sm:flex-row items-center gap-4">
          <a
            ...
            onClick={(e) => {
              e.preventDefault();
              window.location.href = "mailto:rshah107@asu.edu";
            }}
          ...
          >
            ...
            <div className="absolute inset-0 bg-white blur-xl opacity-0 group-hover:opacity-20 transition-opacity rounded-xl pointer-events-none" />
          </a>
